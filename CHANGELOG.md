...
### Changed
- **The ClawHub bundle plugin moved from `@aiops-tools/network-aiops` to
  `@zw008/network-aiops`**, matching the publisher the skill has always been under.
  ...
  `openclaw plugins install clawhub:@zw008/network-aiops`. Nothing about the Python
...
- **The OpenClaw install path is documented.** The ClawHub bundle channel went
  ...
  `openclaw plugins install clawhub:@aiops-tools/network-aiops`. States the `uvx`
